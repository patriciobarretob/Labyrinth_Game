...
public class JsonMultiGoalRefereePlayerDeserializer implements
    JsonDeserializer<SimpleEntry<PlayerInfo, MultiGoalRefereePlayerInfo>> {

  @Override
  public SimpleEntry<PlayerInfo, MultiGoalRefereePlayerInfo> deserialize(
    ...
    MultiGoalRefereePlayerInfo refereePlayerInfo = new MultiGoalRefereePlayerInfo(target);
    return new SimpleEntry<>(playerInfo, refereePlayerInfo);
  }
